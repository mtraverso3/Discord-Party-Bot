...
async function viewSettings(view) {
  ...
  const form = el('form', {},
    ...
    inviterPicker.node,
    el('h5', {}, 'Party bumpers'),
    el('p', { class: 'muted' }, 'Party owners can always bump their own party. Members listed here can run /party bump on any party they belong to, even when they are not the owner.'),
    bumperList,
    bumperPicker.node,
